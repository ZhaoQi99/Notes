## How to use
* bash install_docker. sh docker-19.03.9.tgz

## Reference
* [easypack/docker/install-docker.sh at master · liumiaocn/easypack · GitHub](https://github.com/liumiaocn/easypack/blob/master/docker/install-docker.sh)
* [download docker.tgz](https://download.docker.com/linux/static/stable/x86_64/docker-19.03.9.tgz)
...
usage(){
  ...
  echo "       $0 docker-27.3.1-ce.tgz"
  echo "   usermod -aG docker ${USER}   "
  echo "Get docker-ce binary from: https://download.docker.com/linux/static/stable/x86_64/"
  echo "eg: wget https://download.docker.com/linux/static/stable/x86_64/docker-27.3.1-ce.tgz"
  echo ""
}
